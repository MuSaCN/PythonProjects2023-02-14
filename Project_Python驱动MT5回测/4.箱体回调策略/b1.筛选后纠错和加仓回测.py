...
# (***)推进回测(***)
FwdRprAd.symbollist = ["AUDNZD","CADJPY","CHFJPY","GBPJPY","XAUUSD"] # 策略的品种列表******
...
FwdRprAd.bt_experfolder = "My_Experts\\Strategy深度研究\\4.箱体回调策略\\推进交易.2Y6M"
# (***)ex5的名称格式(***)，要修改
FwdRprAd.bt_expertnameform = "a4.f4.{}.{}.ex5" # 必须是 a1.f5._Symbol.M15 或 a1.f5.EURUSD.M15 格式，最后1个{}对应时间框词缀 或 两个{}对应品种.时间框词缀.
