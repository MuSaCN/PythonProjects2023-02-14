...
['AHPR', 'GHPR', 'Kelly占用仓位杠杆', 'Kelly止损仓位比率', 'LRCorrelation', 'LRStandardError',
 'Sharpe_MT5', 'SQN_MT5_No', 'Sharpe_Balance', 'SQN_Balance', 'SQN_Balance_No', 'Sharpe_Price',  'SQN_Price', 'SQN_Price_No', 'TB', 'Vince止损仓位比率',
...
sortby = "最大相对回撤比占额" # "Kelly占用仓位杠杆" "myCriterion" "盈亏比" "平均盈利" "盈利总和" "盈利交易数量"
