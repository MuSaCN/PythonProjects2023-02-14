...
FwdRprAd.bt_endtime = "2023.02.11"  # 手动指定******，一般为最近的时间
...
# (***)ex5的名称格式(***)，要修改
FwdRprAd.bt_expertnameform = "a4.f5._Symbol.{}.ex5" # 必须是 a1.f5._Symbol.M15 或 a1.f5.EURUSD.M15 格式，最后1个{}对应时间框词缀 或 两个{}对应品种.时间框词缀.
