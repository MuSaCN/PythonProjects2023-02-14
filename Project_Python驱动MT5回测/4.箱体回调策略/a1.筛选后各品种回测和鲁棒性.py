...
# (***)推进回测(***)
FwdRob.symbollist = ["AUDNZD","CADJPY","CHFJPY","EURUSD","GBPJPY","GBPUSD","USDJPY","XAUUSD"] # 策略的品种列表******
FwdRob.timeframe = "TIMEFRAME_M15" # 策略的时间框******
FwdRob.bt_starttime = "2016.07.01"  # 手动指定******，一般为推进样本外的起始
FwdRob.bt_endtime = "2024.01.01"  # 手动指定******，一般为最近的时间

# (***)输出目录(***)
# 输出的总目录******
FwdRob.contentfolder = r"F:\BaiduNetdiskWorkspace\工作---MT5策略研究\7.箱体回调策略"
# 之前推进分析手工建立的目录******
...
FwdRob.bt_experfolder = "My_Experts\\Strategy深度研究\\4.箱体回调策略\\推进交易.Balance_max.2Y6M"
...
#%% ### 单次回测 ###
# (***)ex5的名称格式(***)，要修改
FwdRob.bt_expertnameform = "a1.f4._Symbol.{}.ex5" # 必须是 a1.f5._Symbol.M15 或 a1.f5.EURUSD.M15 格式，最后1个{}对应时间框词缀 或 两个{}对应品种.时间框词缀.
